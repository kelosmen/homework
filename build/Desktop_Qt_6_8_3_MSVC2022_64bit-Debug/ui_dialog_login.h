...
public:
    ...
    QRadioButton *radioButton_customer;
    ...
    void setupUi(QDialog *Dialog_Login)
    {
        ...
        radioButton_customer = new QRadioButton(Dialog_Login);
        radioButton_customer->setObjectName("radioButton_customer");
        radioButton_customer->setGeometry(QRect(140, 170, 101, 31));
        QFont font2;
        font2.setPointSize(18);
        radioButton_customer->setFont(font2);
    ...
    void retranslateUi(QDialog *Dialog_Login)
    {
        ...
        radioButton_customer->setText(QCoreApplication::translate("Dialog_Login", "\351\241\276\345\256\242", nullptr));
